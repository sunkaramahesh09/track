...
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 hidden h-dvh w-[248px] shrink-0 flex-col border-r border-[var(--color-hairline)] bg-white/[0.015] px-4 py-6 backdrop-blur-xl lg:flex">
